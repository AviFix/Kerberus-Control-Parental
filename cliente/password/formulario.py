...
#
# Created: Sat Dec 24 17:39:29 2011
...
"Es muy recomendable que la recuerde.", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.formLayout.setWidget(2, QtGui.QFormLayout.LabelRole, self.label_passwordActual)
        ...
        self.formLayout.setWidget(3, QtGui.QFormLayout.SpanningRole, self.password_actual)
        ...
        self.formLayout.setWidget(5, QtGui.QFormLayout.SpanningRole, self.password1)
        ...
        self.formLayout.setWidget(7, QtGui.QFormLayout.SpanningRole, self.password2)
        ...
        self.formLayout.setWidget(8, QtGui.QFormLayout.FieldRole, self.boton)
