...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.Descripcion_2.setText(QtGui.QApplication.translate("Form", "<html><head/><body><p><a href=\"http://inicio.kerberus.com.ar/en/!RememberPassword!\"><span style=\" text-decoration: underline; color:#0000ff;\">Forgot your password?</span></a></p></body></html>", None, QtGui.QApplication.UnicodeUTF8))
