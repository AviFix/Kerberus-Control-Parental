...
//       port is used. That is, the use of 'GlobalVars::gIocp' and 'gWakeupSemaphore' is
//       mutually exclusive.
//

HANDLE             *gWorkerThread = NULL,       // Array of handles to worker threads
                    gWakeupSemaphore = NULL,    // Wakeup semaphore
                    GlobalVars::gIocp = NULL;               // Handle to the IOCP
    ...
    )
{
    ...
    EnterCriticalSection( &GlobalVars::gOverlappedCS );
    ...
    //
    GlobalVars::gIocp = CreateIoCompletionPort(
...
cleanup:
    ...
    LeaveCriticalSection( &GlobalVars::gOverlappedCS );
    ...
    )
{
    ...
    if ( NULL != GlobalVars::gIocp )
    {
        CloseHandle( GlobalVars::gIocp );
        GlobalVars::gIocp = NULL;
    }
            ...
            if ( NULL == SocketContext->hIocp )
            {
                ...
                else
                {
                    dbgprint("QueueOverlappedOperation: CreateIoCompletionPort() "
                            ...
                            GlobalVars::gIocp, ol->CallerSocket);
                }
            }
    ...
    )
{
    ...
    {
        case LSP_OP_IOCTL:
			dbgprint("ExecuteOverlappedOperation LSP_OP_IOCTL");
            lpdwFlags = NULL;
        ...
        case LSP_OP_RECV:
			dbgprint("ExecuteOverlappedOperation LSP_OP_RECV");
        ...
        case LSP_OP_RECVFROM:
			dbgprint("ExecuteOverlappedOperation LSP_OP_RECVFROM");
        ...
        case LSP_OP_SEND:
			dbgprint("ExecuteOverlappedOperation LSP_OP_SEND");
        ...
        case LSP_OP_SENDTO:
            dbgprint("ExecuteOverlappedOperation LSP_OP_SENDTO");
        ...
        case LSP_OP_TRANSMITFILE:
            dbgprint("ExecuteOverlappedOperation LSP_OP_TRANSMITFILE");
        ...
        case LSP_OP_ACCEPTEX:
            dbgprint("ExecuteOverlappedOperation LSP_OP_ACCEPTEX");
            lpdwFlags = NULL;
        ...
        case LSP_OP_CONNECTEX:
            dbgprint("ExecuteOverlappedOperation LSP_OP_CONNECTEX");
            lpdwFlags = NULL;
        ...
        case LSP_OP_DISCONNECTEX:
            dbgprint("ExecuteOverlappedOperation LSP_OP_DISCONNECTEX");
        ...
        case LSP_OP_TRANSMITPACKETS:
            dbgprint("ExecuteOverlappedOperation LSP_OP_TRANSMITPACKETS");
        ...
        case LSP_OP_RECVMSG:
            dbgprint("ExecuteOverlappedOperation LSP_OP_RECVMSG");
            lpdwFlags = NULL;
        ...
        case LSP_OP_SENDMSG:
			dbgprint("ExecuteOverlappedOperation LSP_OP_SENDMSG");            
    ...
    )
{
    ...
    if ( NULL != olp->lpCallerCompletionRoutine )
    {
        ...
        ret = GlobalVars::gMainUpCallTable.lpWPUQueueApc(
               &olp->CallerThreadId,
               CallUserApcProc,
    ...
    {
        ret = GlobalVars::gMainUpCallTable.lpWPUCloseThread( &olp->CallerThreadId, &Error );
        if ( SOCKET_ERROR == ret )
        {
    ...
    )
{
       ...
       )
    {
        ...
        //
        ret = GlobalVars::gMainUpCallTable.lpWPUCloseSocketHandle(
                ol->CallerSocket, 
               &ol->Error
                );
        if ( SOCKET_ERROR == ret )
    ...
    )
{
    ...
    else
    {
        ...
        ret = GlobalVars::gMainUpCallTable.lpWPUOpenCurrentThread( &ProviderOverlapped->CallerThreadId, &err );
        if ( SOCKET_ERROR == ret )
        {
